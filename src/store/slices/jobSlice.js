...
export const fetchJobs =
  ...
  async (dispatch) => {
    try {
      ...
      let link = "https://job-portalbackend-htvh.onrender.com/api/v1/job/getall?"; // Updated URL
      let queryParams = [];
      if (searchKeyword) {
...
export const fetchSingleJob = (jobId) => async (dispatch) => {
  ...
  try {
    const response = await axios.get(
      `https://job-portalbackend-htvh.onrender.com/api/v1/job/get/${jobId}`, // Updated URL
...
export const postJob = (data) => async (dispatch) => {
  ...
  try {
    const response = await axios.post(
      `https://job-portalbackend-htvh.onrender.com/api/v1/job/post`, // Updated URL
      data,
...
export const getMyJobs = () => async (dispatch) => {
  ...
  try {
    const response = await axios.get(
      `https://job-portalbackend-htvh.onrender.com/api/v1/job/getmyjobs`, // Updated URL
      { withCredentials: true }
    );
...
export const deleteJob = (id) => async (dispatch) => {
  ...
  try {
    const response = await axios.delete(
      `https://job-portalbackend-htvh.onrender.com/api/v1/job/delete/${id}`, // Updated URL
      { withCredentials: true }
    );
