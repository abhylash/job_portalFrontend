...
export const fetchEmployerApplications = () => async (dispatch) => {
  ...
  try {
    const response = await axios.get(
      `https://job-portalbackend-htvh.onrender.com/api/v1/application/employer/getall`, // Updated URL
      {
...
export const fetchJobSeekerApplications = () => async (dispatch) => {
  ...
  try {
    const response = await axios.get(
      `https://job-portalbackend-htvh.onrender.com/api/v1/application/jobseeker/getall`, // Updated URL
      {
        withCredentials: true,
      }
    );
...
export const postApplication = (data, jobId) => async (dispatch) => {
  ...
  try {
    const response = await axios.post(
      `https://job-portalbackend-htvh.onrender.com/api/v1/application/post/${jobId}`, // Updated URL
      data,
      {
        withCredentials: true,
...
export const deleteApplication = (id) => async (dispatch) => {
  ...
  try {
    const response = await axios.delete(
      `https://job-portalbackend-htvh.onrender.com/api/v1/application/delete/${id}`, // Updated URL
      { withCredentials: true }
    );
    dispatch(
